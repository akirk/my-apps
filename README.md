...
- Expands Playground into a first-class install and sharing environment with short install links, a Playground-only Update App Launcher action, better install and update states, direct ZIP plugin sources, plugin ref pinning, improved non-Playground fallback behavior, and more reliable post-install refreshes.
