...
- `my-apps/set-background` updates the launcher background using a preset slug, an image attachment ID, or a remote image URL to sideload or use directly if sideloading fails.
