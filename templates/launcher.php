...
<body class="my-apps-launcher bg-<?php echo esc_attr( $background ); ?>" <?php echo $bg_style; ?>>
	...
	<div class="bottom-toolbar">
		...
		<?php if ( $can_manage ) : ?>
		<a href="<?php echo esc_url( admin_url( 'options-general.php?page=my-apps' ) ); ?>" class="toolbar-btn settings-btn" title="<?php esc_attr_e( 'Settings', 'my-apps' ); ?>">
	...
	<div class="modal-overlay" id="add-app-modal">
		<div class="modal">
			<div class="modal-header">
				<h2><?php esc_html_e( 'Add Link', 'my-apps' ); ?></h2>
